...
export const Portfolio = () => {
  ...
  useEffect(() => {
    const filtered = projects.filter(
      (project) => project.area === activeFilter || activeFilter === filters.All
    );
    ...
    <div className="container">
      ...
      <div className="container-section-title">
        ...
        <div className="projects-filter">
          ...
          <p
            onClick={() => handleFilter(filters.Frontend)}
            className={`filter-buttons ${
              activeFilter === filters.Frontend ? "active" : ""
            }`}
          >
            Front-end
          </p>
          <p
            onClick={() => handleFilter(filters.Backend)}
            className={`filter-buttons ${
              activeFilter === filters.Backend ? "active" : ""
            }`}
          >
            Back-end
          </p>
          <p
            onClick={() => handleFilter(filters.Others)}
            className={`filter-buttons ${
              activeFilter === filters.Others ? "active" : ""
            }`}
          >
            Others
          </p>
